...
//Less stable than 1, but better throwing detections
...
void loop()
{
  ...
  //if(spin < 10000 & amp > 25000) {
    if (f_rx < 8000 & amp > 20000 & f_rx > 200) {
...
float dopplerVel(double f_rx) {
  ...
  float intermediate = 0.00622; //c/(2*f_tx) done outside so that we don't worry about overflow.
